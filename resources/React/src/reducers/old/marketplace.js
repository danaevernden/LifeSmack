const DEFAULT_STATE = {
  oldmarketplace:
  [{goal_id: 1, name: "Joan Rivers", specialist_id: 1, goal_name: "Get your first gig as a comedian", rating: 2, plan_description:
  ...
  {goal_id: 2, name: "Meb", specialist_id: 2, goal_name:"PR on your next 10K race", rating: 4, plan_description:
...
{goal_id: 3, name: "David Ortiz", specialist_id: 3, goal_name: "Tips on improving your batting average", rating : 3, plan_description: "watch David Ortiz discuss his secrets for improving his batting average",
category: "supplemental", hashtags: "baseball, batting, Red Sox"}
  ]
}

const oldmarketplace = (state = DEFAULT_STATE, action) => {
  switch(action.type) {
